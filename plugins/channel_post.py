...
async def channel_post(client: Client, message: Message):
    reply_text = await message.reply_text("SEK LUR..!!!", quote = True)
    try:
    ...
    reply_markup = InlineKeyboardMarkup([[InlineKeyboardButton("INI LINK NYA", url=f'https://telegram.me/share/url?url={link}')]])

    await reply_text.edit(f"<b>NIH LINK NYA</b>\n\n{link}", reply_markup=reply_markup, disable_web_page_preview = True)
